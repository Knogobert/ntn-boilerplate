...
3. Change colors, favicon, content & content collections
   ...
   - Favicon is generated by [@nuxt/pwa](https://pwa.nuxtjs.org/). You should change the `public/icon.png` to something new, and then match the new filename and source in `nuxt.config.js` under `pwa.icon`. Replace the preview.jpg as well.
